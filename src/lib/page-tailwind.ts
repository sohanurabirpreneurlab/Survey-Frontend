...
export const surveyTw = {
  ...
  radioCard: "flex items-start gap-3 rounded-app-md border border-app-border [border-style:solid] bg-white/[0.94] p-4 accent-app-primary transition-[border-color,box-shadow,background-color] hover:border-app-border-strong [&_input[type=radio]]:mt-1 [&_input[type=radio]]:shrink-0",
  radioCopy: "grid gap-1 leading-6",
  ...
  radioInline: "flex items-start gap-3 accent-app-primary [&_input[type=radio]]:mt-1 [&_input[type=radio]]:shrink-0",
  radioInlineCopy: "grid gap-1 leading-6 [&_span]:text-app-text-soft",
